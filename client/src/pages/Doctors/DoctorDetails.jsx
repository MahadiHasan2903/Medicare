            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-[6px]">
                  ...
                  <span className="text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semiboldd text-textColor">
                    (270)
                  </span>
                </div>

                <p className="text_para text-[14px] ledaing-5 md:text-[15px] lg:max-w-[390px]">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit
                  suscipit error blanditiis.
                </p>
              </div>
            </div>
